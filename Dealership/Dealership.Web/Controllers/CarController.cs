...
namespace Dealership.Web.Controllers
{
    public class CarController : Controller
    {
        ...
        public CarController(ICarService carService, IBrandService brandService, IBodyTypeService bodyTypeService, IColorTypeService colorTypeService, IFuelTypeService fuelTypeService, IGearTypeService gearTypeService)
        {
