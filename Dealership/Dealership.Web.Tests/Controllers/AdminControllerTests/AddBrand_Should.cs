...
namespace Dealership.Web.Tests.Controllers.AdminControllerTests
{
    ...
    public class AddBrand_Should
    {
        ...
        public void ReturnRedirectResult_WhenCalled()
        {
            ...
            var viewModel = new AddBrandViewModel() { Brand = "Brand" };

            // Act
            var result = controller.AddBrand(viewModel);
        ...
        public void InvokeCorrectServiceMethod_WhenCalled()
        {
            ...
            // Assert
            brandServiceMock.Verify(s => s.Add(It.IsAny<Brand>()), Times.Once);
        }
