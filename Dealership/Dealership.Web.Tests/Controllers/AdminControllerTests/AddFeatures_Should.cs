...
{
    [TestClass]
    public class AddFeatures_Should
    {
        ...
        public void ReturnsViewResult_WhenCalled()
        {
            ...
            brandServiceMock.Setup(bc => bc.GetBrands()).Returns(brands);

            // Act
            var result = controller.AddFeatures();
            // Assert
        ...
        public void ReturnsCorrectViewModel_WhenCalled()
        {
            ...
            // Act
            var result = controller.AddFeatures() as ViewResult;
            // Assert
            Assert.IsInstanceOfType(result.Model, typeof(AddViewModel));
        }
